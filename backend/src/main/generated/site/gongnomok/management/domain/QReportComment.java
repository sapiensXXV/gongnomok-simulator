...
public class QReportComment extends EntityPathBase<ReportComment> {
    ...
    private static final long serialVersionUID = -2078067362L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QReportComment reportComment = new QReportComment("reportComment");

    public final site.gongnomok.comment.domain.QComment comment;
    ...
    public QReportComment(Class<? extends ReportComment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.comment = inits.isInitialized("comment") ? new site.gongnomok.comment.domain.QComment(forProperty("comment"), inits.get("comment")) : null;
    }
