...
//        log.info("scroll_name={}", name);
    ...
    public static int calculateScore(EnhanceSuccessDto success, String name) {

        EnhanceScroll findScroll = from(name);

        return findScroll.getTen() * success.getTen() +
            findScroll.getSixty() * success.getSixty() +
            findScroll.getHundred() * success.getHundred();
    }
