...
const gloves_phy_atk: ScrollInfo = {
...
const gloves_health: ScrollInfo = {
...
const overall_swift: ScrollInfo = {
...
const overall_defence: ScrollInfo = {
...
const overall_intel: ScrollInfo = {
...
const overall_lucky: ScrollInfo = {
...
const overall_strength: ScrollInfo = {
...
const bottom_defence: ScrollInfo = {
...
const bottom_health: ScrollInfo = {
...
const one_handed_sword_phy_atk: ScrollInfo = {
...
const one_handed_sword_acc: ScrollInfo = {
...
const one_handed_axe_phy_atk: ScrollInfo = {
...
const one_handed_axe_acc: ScrollInfo = {
...
const one_handed_blunt_phy_atk: ScrollInfo = {
...
const one_handed_blunt_acc: ScrollInfo = {
...
const two_handed_sword_phy_atk: ScrollInfo = {
...
const two_handed_sword_acc: ScrollInfo = {
...
const two_handed_axe_phy_atk: ScrollInfo = {
...
const two_handed_axe_acc: ScrollInfo = {
...
const two_handed_blunt_phy_atk: ScrollInfo = {
...
const two_handed_blunt_acc: ScrollInfo = {
...
const spear_phy_atk: ScrollInfo = {
...
const polearm_phy_atk: ScrollInfo = {
...
const dagger_phy_atk: ScrollInfo = {
...
const crossbow_phy_atk: ScrollInfo = {
...
const earring_swift: ScrollInfo = {
...
const earring_intel: ScrollInfo = {
...
const earring_lucky: ScrollInfo = {
...
const earring_health: ScrollInfo = {
...
const cape_strength: ScrollInfo = {
...
const shield_defence: ScrollInfo = {
...
const shield_health: ScrollInfo = {
...
const shield_strength: ScrollInfo = {
...
export const SCROLL_INFO = new Map<string, ScrollInfo>([
