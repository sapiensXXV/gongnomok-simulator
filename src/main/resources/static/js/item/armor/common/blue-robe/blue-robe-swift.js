...
let blueRobeSwiftImgPath = '../img/item/weapon/blue-sauna-robe.png';
...
window.addEventListener('keydown', (e) => {
    ...
    if (input === 'r' || input === 'R' || input === 'ㄱ' || input === 'ㄲ') {
        ...
        blueRobeSwiftPriceResetBtn.focus();
    }
});
window.addEventListener('keyup', (e) => {
    ...
    if (input === 'r' || input === 'R' || input === 'ㄱ' || input === 'ㄲ') {
        ...
        blueRobeSwiftPriceResetBtn.blur();
    }
});
...
blueRobeSwiftPriceResetBtn.addEventListener('mouseup', workGlovePriceResetBtnMouseUp);
...
function workGlovePriceResetBtnMouseUp() { blueRobeSwiftPriceResetBtn.blur() }
